...
let downloadProjectsSideEl = document.querySelector(".downloadProjectsSide");
...
let bodyPhoneDownload_ProjectsEl = document.querySelector(
  ".bodyPhoneDownload_Projects"
);
...
let bodyPhoneInteresertImg2El = document.querySelector(
  ".bodyPhoneInteresertImg2"
);
let bodyPhoneInteresertImg3El = document.querySelector(
  ".bodyPhoneInteresertImg3"
);
...
let bodyPhoneMyProjectsLinkEl = document.querySelector(
  ".bodyPhoneMyProjectsLink"
);
...
function portraitNamePage() {
  if (isPortraitMode()) {
    ...
    bodyPhoneNameP1El.innerHTML =
      "Jeg heter thorstein andreassen og går på lillestrøm vgs. Dette er min mobil versjon, av nettsiden/porteføljen min. Dersom du vil se en bedre versjonen av denne nettsiden. Åpne den på pcen din, der du har media orientation på landscape istedenfor portrait som er automatisk på mobil :DD";
    bodyPhoneNameP2El.innerHTML =
      "dette er kun for å vise at jeg kan putte inn ett bilde om jeg vil";
...
function portraitInteresertPage() {
  if (isPortraitMode()) {
    ...
    bodyPhoneNameP1El.innerHTML =
      "Jeg synes mye er kult, blant annet it er fett. Jeg liker også å trene, mer spesifikt bryting og styrke";
    bodyPhoneNameP2El.innerHTML =
      "Her har dere ett bilde som kan være relevant";
    console.log(bodyPhoneNameImg2El.classList);
...
function checkProjects() {
  if (isPortraitMode()) {
    ...
    bodyPhoneMyProjectsH1El.innerHTML =
      "under ser du mine prosjekter, for å kunne bruke de ordentlig må du være på pc. Grunnet at jeg hadde disse prosjektene før vi lærte om mobil modus";
  }
}
